...
/*---------------------------------------------------Tooltips-----------------------------------*/
  ...
  function setTooltips() {
    ...
    //heading section
    Tipped.create('#tooltipsonoff',        'Tips on/off, default is off!',                                  { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });


    Tipped.create('.headingtip',           'https://thenewstatistics.com ',                                 { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //1. The population section
    Tipped.create('#populationdisplaydiv', 'The Population: Choose population parameters and shape',        { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.mutip',                'Mean. Use slider or type in value, min 0, max 100',             { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.sigmatip',             'SD Use slider or type in value',                                { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.skewtip',              'Use dropdown to select amount of skew',                         { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.customtip',            'Click and drag from left to right to draw your own shape',      { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });


    //2. Click to display section
    Tipped.create('#displayoptionsdiv',    'Choose what’s displayed in upper panel',                        { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.popntip',              'Display the curve',                                             { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.sdlinestip',           'Display lines to mark &mu;, and SD units either side of &mu;',  { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.fillpopntip',          'Display circles to mark some population data points',           { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //3. Run controls section
    Tipped.create('#runcontrolsdiv',       'Buttons control sampling',                                      { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#clearsample',          'Clear samples, ready for new run',                              { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#takesample',           'Take one independent random sample',                            { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#runfreely',            'Start or stop sampling',                                        { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#speed',                'Set sampling speed',                                            { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //4. Samples section
    Tipped.create('#samplelabel',          'Choose sample size, see number of samples in current run, see information about latest sample', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.ntip',                 'Use dropdown to select sample size',                            { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#nosamples',            'Number in current run',                                         { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.musampletip',          'Mean of latest sample',                                         { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.sdsampletip',          'SD of latest sample',                                           { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    Tipped.create('.moeptip',              'Calculated assuming &sigma; known',                             { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.moestip',              'Calculated using <em>s</em> of latest sample',                  { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });


    Tipped.create('.datapointstip',        'Display dot plot of latest sample',                             { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.samplemeanstip',       'Display mean of latest sample',                                 { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.droppingmeanstip',     'Display dance of the means',                                    { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //5. Mean heap section
    Tipped.create('#heapsectionspan',      'Heap of sample means in the current run',                       { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.meanheaptip',          'Display heap',                                                  { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.samplecurvetip',       'Sampling distribution curve: Display the normal distribution that is the theoretically expected sampling distribution of means, in the long run, according to the central limit theorem. Curve is scaled vertically for approximate fit to current heap', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.samplelinestip',       'Display lines to mark &mu; and SE units either side of &mu;',   { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.plusminusmoetip',      'Display stripe at bottom and vertical lines to mark this interval, which is the length of CIs when &sigma; is known', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.meanheapMtip',         'Mean of means in the heap  ',                                   { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.meanheapsetip',        'SD of means in the heap',                                       { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    Tipped.create('.curveheapsetip',       'SD of the sampling distribution curve',                         { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.nomeansinheaptip',     'Number that have dropped down into the heap',                   { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //6. CI section
    Tipped.create('#confidenceintervalsdiv', 'CIs on sample means',                                         { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.cipcnttip',            'Use dropdown to select confidence level',                       { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.showmoetip',           'Display CIs on means',                                          { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    Tipped.create('.moeknowntip',          'Assume $sigma; is known ',                                      { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.moeunknowntip',        'Assume &sigma; is not known',                                   { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //7. Capture of mean
    Tipped.create('#captureofmupanel',     'Explore the capture of  by CIs',                               { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.capturemulinetip',     'Display line to mark &mu;',                                     { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.capturemutip',         'Turn on colours to indicate capture, red CIs do not capture &mu;', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    
    
    Tipped.create('#numbercapturingdiv',   'Number of CIs in current run that capture &mu;',                { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#nosamplesydiv',        'Total number of samples in current run',                        { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#capturedpercentdiv',   'Percent of CIs in current run that capture &mu;',               { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    //8.Capture of next mean
    Tipped.create('.capturenextmeantip', 'Explore capture by CIs of the next mean, which is the mean just above a CI in the dance. When a CI does NOT capture, a pink diagonal line joins a limit of the CI up to the mean just above', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    Tipped.create('#numberofnextmeansdiv',        'Number of means available for capture, one less than number of samples in current run', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#numbercapturingnextmeandiv',  'Number of CIs that capture next mean in current run',    { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#percentcapturingnextmeandiv', 'Percent of CIs in current run that capture next mean',   { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    
    //9. p values
    Tipped.create('.danceptip',                   'Display dance of the p values',                          { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.psound',                      'Turn on sounds, may need a slow sampling rate to hear every sound', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('.volumetip',                   'Set volume',                                             { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });

    Tipped.create('#nullhypothesislabel',         '&mu;0=50: Fixed null hypothesis value, marked by vertical line', { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
    Tipped.create('#cohensdlabel',                "Cohen’s &delta;<x>: Population effect size in units of &sigma;, so &delta; = (&mu; – &mu;0) / &sigma; ", { skin: 'esci', size: 'large', showDelay: 750, behavior: 'mouse', target: 'mouse', maxWidth: 250, hideOthers: true, hideOnClickOutside: true, hideAfter: 0 });
